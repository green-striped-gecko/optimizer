...
looks like the design is quite good, but there are better ones. It is likely that with a better design you could have shown the effect of tree scrub cover.... (which we actually did using the full data set = 31 populations....)
